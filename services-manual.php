...
<head>
    <meta charset="utf-8" />
    <title>Rimpido GmbH - EHS Manual</title>
    ...
    <style type="text/css">
       ...
       .services-pre-content p{
        ...
        body.dark .magnific-popup-gallery figure{
        ...
        <section class="services ">
            ...
            <div class="container">
                ...
                <div class="text-center top-text " style="padding-top: 50px;">
                    <?php
                        echo $lang['manual_header'];
                        echo $lang['manual_sub_header'];
                    ?>
                </div>
                <!-- Main Heading Starts -->
                <!-- Divider Starts -->
                ...
                <div class="row">
                    ...
                    ?>
                        <div class="col-md-6 ">
                            <div class="services-content">
                             <?php
                                echo $lang['manual_first_content'];
                             ?>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="magnific-popup-gallery">
                                <figure class="thumbnail thumbnail__portfolio" >
                                    <a class="image-wrap" href="img/rimpido/handbuch.png" data-gal="magnific-pop-up[image]" title="Image project"><img class="img-responsive" src="img/rimpido/handbuch_s.png" alt="Handbook"  /><span class="zoom-icon"></span></a>
                                </figure>    
                            </div>
                    </div>
                  ...
                  ?>
                    ...
                    <div class="col-md-12">
                        <div class="services-pre-content">
                            <?php
                                echo $lang['manual_second_content'];
                            ?>
                        </div>
                    </div>
                </div>
