                ...
                <nav class="navbar">
					...
					<div id="navbarSupportedContent" class="collapse navbar-collapse navbar-responsive-collapse">
						...
						<ul class="nav navbar-nav" id="main-navigation">
                            <li class="active"><a href="index.php"><i class="fa fa-home"></i> Start Page</a></li>
							<li class="dropdown" id="services" onclick="changeActiveNavBar()">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li><a href="#">Phrase Library</a></li>
									<li><a href="services-training.php">Training</a></li>
									<li><a href="#">EH&S Tools</a></li>
									<li><a href="#">Chemistry Service</a></li>
